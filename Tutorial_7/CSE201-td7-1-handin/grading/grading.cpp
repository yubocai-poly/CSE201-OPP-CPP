...
int test_reverse_even(std::ostream &out, const std::string test_name) {
  ...
  auto test_vector = [](ostream &out, vector<int> input, vector<int> expected) {
    std::string input_str = get_vector_str("int", false, input);
    vector<int> result = reverse_even(input);
    std::string result_str = get_vector_str("int", false, result);
    std::string expected_str = get_vector_str("int", false, expected);
...
int test_same_coordinates(std::ostream &out, const std::string test_name) {
  ...
  auto test_vector = [](ostream &out,
    ...
    std::string list_of_x_str = get_vector_str("double", false, list_of_x);
    std::string list_of_y_str = get_vector_str("double", false, list_of_y);
    std::string expected_str = get_vector_str("Coordinate", false, expected);

    vector<Coordinate> result = same_coordinates(list_of_x, list_of_y);
    std::string result_str = get_vector_str("Coordinate", false, result);
...
int test_filter_max(std::ostream &out, const std::string test_name) {
  ...
  auto test_vector = [](ostream &out,
                        ...
                        vector<int> expected) {
    std::string max_vector_str = get_vector_str("int", false, max_vector);
    std::string other_vector_str = get_vector_str("int", false, other_vector);
    std::string expected_str = get_vector_str("int", false, expected);
